            ...
            <ul class="nav nav-collapse">
                <li>
                    <a class="sub-link" href="{{ route('back.warehouse.add') }}">
                        <span class="sub-item">{{ __('Add Warehouse') }}</span>
                    </a>
                </li>
                <li>
                    <a class="sub-link" href="{{ route('back.warehouse.index') }}">
                        <span class="sub-item">{{ __('All Warehouse') }}</span>
                    </a>
                </li>
            </ul>
        </div>
