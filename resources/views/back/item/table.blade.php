@foreach ($datas as $data)
    <tr id="product-bulk-delete">
        ...
        <td>
            <img src="{{ $data->thumbnail ? asset('assets/images/' . $data->thumbnail) : asset('assets/images/placeholder.png') }}"
                alt="Image Not Found">
        </td>
        <td>
            {{ $data->name }}
        ...
        <td>
            {{ App\Helpers\PriceHelper::adminCurrencyPrice($data->discount_price) }}
        </td>
        <td>
            <div class="dropdown">
        ...
        <td>
            <p
                class="
        @if ($data->is_type == 'undefine') @else
            bg-info badge text-white @endif
      ">
        ...
        <td>
            ...
            <a href="{{ route('back.attribute.index', $data->id) }}">Exist</a>
            @else
            <a href="{{ route('back.attribute.index', $data->id) }}">None</a>
        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
                    ...
                    @endif
                    @if ($data->item_type == 'normal')
                        <a class="dropdown-item" href="{{ route('back.attribute.index', $data->id) }}"><i
                                class="fas fa-angle-double-right"></i> {{ __('Attributes') }}</a>
                        <a class="dropdown-item" href="{{ route('back.option.index', $data->id) }}"><i
                                class="fas fa-angle-double-right"></i> {{ __('Attribute Options') }}</a>
                    @endif
