        ...
        <div class="row">
          ...
          ">{{ __('out of stock') }}</span>
                    ...
                    @if ($item->previous_price && $item->previous_price != 0)
                        <div class="product-badge bg-goldenrod  ppp-t">
            ...
            <div class="col-xxl-7 col-lg-6 col-md-6">
                <div class="details-page-top-right-content d-flex align-items-center">
                    <div class="div w-100">
                        ...
                        <input type="hidden" value="{{ App\Helpers\PriceHelper::setCurrencySign() }}" id="set_currency">
                        ...
                        @if($item->attributes->first()->abbrivation != "m2")
                                @php
                                    $attr = $item->attributes->first();
                                    $option = $attr->options->first();
                                @endphp
                        <span class="h3 d-block price-area">
                           
                            <span id="main_price"
                                class="main-price">$ {{ $option->price }}</span>
                        </span>
                        @else
                        <span class="h3 d-block price-area">
                           
                            <span id="main_price"
                                class="main-price"></span>
                        </span>
                        @endif
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            ...
                                                            <input 
                                                                ...
                                                                id="{{$option->id}}" class="input-hidden" />
                                                                
                                                                <label for="{{$option->id}}" >
                                                                <span id="optionLabel_{{ $option->id }}" class="mb-2">{{ $option->length }} x {{ $option->height }} x {{ $option->broad }} {{ $option->attribute->abbrivation == 'm2'  ? 'm²' : ''}}</span><br>
                                                                <img id="option-check_{{$option->id}}" class="attribute_option" onclick="optionCheck({{$option->id}})" src="{{ asset('/assets/images/'. $option->image ) }}" style="width:140px;height:120px">
                                                                    
                                                            </label>

                                                            <!-- <option value="{{ $option->name }}" data-type="{{ $attribute->id }}"
                                                                data-href="{{ $option->id }}"
                                                                data-target="{{ App\Helpers\PriceHelper::setConvertPrice($option->price) }}">
                                                                {{ $option->name }}</option> -->
                                                                </div>
                                                        @endforeach
                        ...
                        <div class="row align-items-end pb-4">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        @if ($item->item_type == 'normal')
                                        <select name="option-quantity" id="option-quantity" class="form-control mb-2">
                                        @for($i=1; $i <= 10;$i++)
                                            <option value="{{ $option->quantity * $i }}_{{ $option->price }}">{{ $option->quantity * $i }}</option>
                                        @endfor
                                        </select>
                                    ...
                                    <div class="col-lg-6">
                                        <span id="option-qty-price">$ {{ $option->price * $option->quantity }}</span>
                                    </div>
                                </div>
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    ...
                                    <div class="product-thumb">
                                        <img class="lazy"
                                            data-src="{{ asset('assets/images/' . $related->thumbnail) }}" alt="Product">
                                    ...
                                    <div class="product-card-body">
                                        ...
                                        <h4 class="product-price">
                                            @if ($related->previous_price != 0)
                                                <del>{{ App\Helpers\PriceHelper::setPreviousPrice($related->previous_price) }}</del>
                                            @endif
                                            {{ App\Helpers\PriceHelper::grandCurrencyPrice($related) }}
                                        </h4>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="email" id="review-email" value="{{ $user->email }}"
                                        required>
                                </div>
                            </div>
                        </div>
